...
import { getCustomers, saveCustomer, deleteCustomer, updateCustomer } from "../reducers/CustomerReducer";
...
//       return;
//     }
//     dispatch(saveCustomer({ id, name, nic, email, phone }));
//     resetForm();
//   };
...
//       return;
//     }
//     dispatch(updateCustomer({ id, name, nic, email, phone }));
//     resetForm();
//   };
...
//         <tbody>
//           {customers.map((customer) => (
//             <tr key={customer.id} className="hover:cursor-pointer hover:bg-slate-600 hover:text-white">
//               <td className="border px-4 py-2">{customer.id}</td>
//               <td className="border px-4 py-2">{customer.name}</td>
//               <td className="border px-4 py-2">{customer.nic}</td>
//               <td className="border px-4 py-2">{customer.email}</td>
